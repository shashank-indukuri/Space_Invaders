...
{
    class PlayerTwoScene : GameSceneState
    {
        // Constructor
        public PlayerTwoScene()
        {
            this.Initialize();
        }
        ...
        public override void Initialize()
        {
            ...
            pMissileGroup.LinkSprite(pSBBoxes);
            pMissileGroup.LinkCollisionSprite(pSBAliens);
        ...
        public override void HanldeState()
        {
            ...
            Player pPlayer2 = PlayerManager.Find(Player.Name.Player2);
            pPlayer2.RemoveLife();
            int lifes = pPlayer2.GetNumOfLifes();
            ...
            {
                if (pPlayer2.GetNumOfLifes() != 0)
                {
                    TimerEventManager.Add(TimerEvent.Name.SwiftScene, 0.5f, new SwiftSceneCommand(GameSceneContext.Scene.Player1));
                ...
                {
                    PlayerManager.UpdateHighScore(pPlayer2.GetScore());
                    FontManager.UpdateScore();
        ...
        public override void Entering()
        {
            ...
            PlayerManager.SetActivePlayer(Player.Name.Player2);
            this.LoadOnEntry();
